...
import static com.example.xpuzzle.R.styleable.View;
...
public class GridItemsAdapter extends BaseAdapter{
    ...
    @Override
    public int getCount(){return mBitmapItemLists.size();}

    @Override
    public Object getItem(int position){return mBitmapItemLists.get(position);}
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView ==null){
            ...
            //设置布局 图片
            if ( mBitmapItemLists.get(position)!=null)
